from nms import nms_c_src, nms_simd_src, nms_gpu_src # Our methods
...
def nms_c(boxes, prob, threshold, form='center'):
    ...
    nms_c_src() # Work should be done in here
...
def nms_simd(boxes, prob, threshold, form='center'):
    ...
    nms_simd_src() # Work should be done in here
...
def nms_gpu(boxes, prob, threshold, form='center'):
    ...
    nms_gpu_src() # Work should be done in here
