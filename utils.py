...
def bbox_center_to_diagonal(bbox):
    """convert a bbox of form [xmin, ymin, xmax, ymax] to [cx, cy, w, h]. Works for numpy array. """
...
def bbox_center_to_lowerleft(bbox):
    """convert a bbox of form [minx, miny, maxx, maxy] to [minx, miny, w, h]. Works for numpy array. """
