...
__kernel void nms(__global float *xmins, __global float *ymins, __global float *widths, __global float *heights, __global int *order, __global int *keep, float threshold, int n, int *probs) {
